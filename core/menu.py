...
options = ["Bitcoin P2PKH (Pay to Public Key Hash): 1...", "Bitcoin P2SH (Pay to Script Hash): 3...", "Bitcoin Bech32 (SegWit): bc1q...", "Etherium: 0x...", "Информация о типах адресов", "Выход"]
